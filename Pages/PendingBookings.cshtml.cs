...
namespace TutorBuddy_MCsoft.Pages
{
    public class PendingBookingsModel : PageModel
    {
        ...
        public async Task OnGetAsync(int? id)
        {
            ...
            IndividualBooking = await _context.IndividualBookings.Include(ib => ib.Session).Include(ib => ib.Student).Where(ib => ib.Session.ModuleTutor.Tutor.StudentNumber == id).ToListAsync();
        }
    }
}
